...
💻 Desenvolvedor de Software com foco em construção de soluções eficientes, escaláveis e orientadas a aprendizado contínuo.  
🚀 Buscando evolução constante na interseção entre **engenharia de software, IA aplicada e boas práticas de desenvolvimento**.
...
> 🧠 **IA & Dados**: Python aplicado a Inteligência Artificial, automações, análise e fundamentos de Machine Learning (em aprofundamento na pós).
...
<img height="180em" src="https://github-readme-stats.vercel.app/api/top-langs/?username=RafaMacoto&layout=compact&langs_count=8&theme=midnight-purple" />
